...
include "splunk_o11y_regional_integration" {
  path   = find_in_parent_folders("_global_settings/splunk_o11y_regional_integration.hcl")
  expose = true
}

# Version of module to use.
locals {
  module_name     = "splunk_o11y_regional_integration"
