locals {
  ...
  subscription_settings_data = read_terragrunt_config(find_in_parent_folders("forge_subscription/subscription_settings.hcl"))
}
...
inputs = {
  ...
  forge = local.subscription_settings_data.locals.forge
}
