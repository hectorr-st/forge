...
| [aws_cloudwatch_event_rule.every_hour_runner_group](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_event_rule) | resource |
...
| [aws_iam_policy.lambda_policy_runner_group](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
...
| [local_file.github_app_pem](https://registry.terraform.io/providers/hashicorp/local/latest/docs/resources/file) | resource |
...
| [external_external.github_app_jwt](https://registry.terraform.io/providers/hashicorp/external/latest/docs/data-sources/external) | data source |
...
| <a name="input_log_level"></a> [log\_level](#input\_log\_level) | Log level for the module. | `string` | n/a | yes |
...
| <a name="input_tenant"></a> [tenant](#input\_tenant) | Map of tenant configs | <pre>object({<br/>    name = string<br/>    teleport = object({<br/>      tenant_name = string<br/>    })<br/>    region_alias        = string<br/>    vpc_alias           = string<br/>    iam_roles_to_assume = optional(list(string), [])<br/>    ecr_registries      = optional(list(string), [])<br/>  })</pre> | n/a | yes |
