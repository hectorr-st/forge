...
Thanks for your interest in contributing to `Forge`! Here are a few general guidelines on contributing and
...
- Review existing pull requests, and testing patches against real existing applications that use `Forge`.
- Write a test, or add a missing test case to an existing test.

Thanks again for your interest on contributing to `Forge`!
